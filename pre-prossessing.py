...
save_classifier = open("Classifiers/sgdc", "wb")
pickle.dump(sgdc, save_classifier)
save_classifier.close()


# nu_SVC = SklearnClassifier(NuSVC())
# nu_SVC.train(training_data)
# save_classifier = open("Classifiers/nu_SVC.pickle", "wb")
# pickle.dump(nu_SVC, save_classifier)
# save_classifier.close()
...
test_string = "hi guys plz subscribe to my channel"

testing_string2 = "i thought she died haha"

#comb.classification_confidence()
